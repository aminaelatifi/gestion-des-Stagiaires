...
<head>
    ...
    <link rel="stylesheet" href="register2css.css">
               ...
               <form action="login_register.php" method="post">
                  <h2>
                    ...
                    <button type="reset">X</button>
                         ...
                         <button type="submit" class="reg-btn" name="register">S'inscrire  </button>
                         <p>Avez-vous déjà un compte ? <a href="login2.php" class="lie">Connexion</a></p>
               </form>
